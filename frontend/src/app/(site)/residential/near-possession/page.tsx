...
export const metadata: Metadata = {
    ...
    alternates: { canonical: "https://www.uniselrealty.com/residential/near-possession" },
    openGraph: {
        ...
        url: "https://www.uniselrealty.com/residential/near-possession",
...
const NearPossessionPage = () => {
    const breadcrumbs = breadcrumbSchema([
        ...
        { name: "Near Possession", url: "https://www.uniselrealty.com/residential/near-possession" },
    ]);
